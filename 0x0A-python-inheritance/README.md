...
-   [Inheritance](https://intranet.hbtn.io/rltoken/99aGWGmLu8zsaiiJg7HCYQ "Inheritance")
-   [Multiple inheritance](https://intranet.hbtn.io/rltoken/ozYK1JSbEU4U6BqTggCjSA "Multiple inheritance")
...
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/hdN09jbXotPDd8FfgfJdIQ "explain to anyone"),  **without the help of Google**:
