...
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/4pcL_NcWIg6st6SJ_LN8HQ "explain to anyone"),  **without the help of Google**:
...
-   You must use the  [Turtle graphics module](https://intranet.hbtn.io/rltoken/AuDu9jy9zmIN12YpQaHm0A "Turtle graphics module")
